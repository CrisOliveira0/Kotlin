...
class rodo {
    ...
    class MainActivity : AppCompatActivity() {
        ...
        fun buttonClick(view: View){
            ...
            buttonSelecionado.setBackgroundResource(com.example.jogodavelha.R.drawable.sasaki)
            ...
            tabuleiro[rX][rY] = "O"
            buttonSelecionado.setBackgroundResource(com.example.jogodavelha.R.drawable.poseidon)
